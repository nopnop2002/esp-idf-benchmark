/*
 * I ported from https://github.com/Keith-S-Thompson/dhrystone/tree/master/v2.2
 */
...
void dhrystone(void *pvParameters)
{
  ...
  while (!Done) {
    ...
    //printf("End_Time=%ld Begin_Time=%ld User_Time=%ld Too_Small_Time=%d\n", End_Time, Begin_Time, User_Time, Too_Small_Time);
